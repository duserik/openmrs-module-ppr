...
<table style="border:1px; table-spacing:0px">
	...
	<tr>
		...
		<td>${clientSeenByNurseMalePed.indicatorMonday + deceasedARTClientsMalePed.indicatorTuesday + clientSeenByNurseMalePed.indictorWednesday + clientSeenByNurseMalePed.indicatorThursday + clientSeenByNurseMalePed.indicatorFriday + clientSeenByNurseMalePed.indicatorSuturday}</td>
	</tr>
	<tr>
		<td></td>
		<td>Pediatric - Female</td>
