 ...
 */
package org.openmrs.module.reportingvariables.web.controller;
...
/**
 * This class configured as controller using annotation and mapped with the URL of 'module/reportingvariables/reportingvariables'.
 */
@Controller("reportingVariablesManageController")
@RequestMapping(value = "/module/reportingvariables/reportingvariables")
public class ReportingVariablesManageController{

	/** Logger for this class and subclasses */
	protected final Log log = LogFactory.getLog(getClass());

	/** Success form view name */
	private final String SUCCESS_FORM_VIEW = "/module/reportingvariables/reportingvariables";
	...
	protected User formBackingObject(HttpServletRequest request) throws Exception {
		...
		log.info("Testing if the controller is being hit: ************************************: " + user);
		return user;
	}
