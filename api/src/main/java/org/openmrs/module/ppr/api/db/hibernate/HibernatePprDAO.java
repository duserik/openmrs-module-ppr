 ...
 */
package org.openmrs.module.ppr.api.db.hibernate;
...
import org.openmrs.module.ppr.api.db.PprDAO;
...
public class HibernatePprDAO implements PprDAO {
    ...
    public Collection<Encounter> clientSeenByNurse(String startDate, String endDate, String gender, String ageRange) {
		...
		sb.append("inner join person prsn on enc.provider_id = prsn.person_id ");
